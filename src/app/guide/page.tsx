...
export default function GuidePage() {
  ...
  return (
    <>
      <PageHero eyebrow="Expert Advice" title="The Smooth Swing Buying Guide" subtitle="Everything you need to build a better bag without overspending." size="lg" />
          ...
          {sections.map(s => (
            <div key={s.id} id={s.id}>
              ...
              <div className="bg-[#f5f3ef] border-l-4 border-[#2e4a2c] p-5 mb-8">
                <p className="text-[#2e4a2c] font-bold text-[12px] uppercase mb-2">Pro Tip:</p>
