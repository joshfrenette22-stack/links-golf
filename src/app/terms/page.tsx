...
export default function TermsPage() {
  return (
    <PolicyLayout title="Terms & Conditions" lastUpdated="March 1, 2026">
      <h2>Acceptance of Terms</h2><p>By using this site, you agree to these terms in full.</p>
      <h2>Products &amp; Descriptions</h2><p>We make every effort to accurately describe condition and specifications. Minor discrepancies may exist due to photography and individual club variation.</p>
      <h2>Pricing</h2><p>All prices are in USD. We reserve the right to change prices at any time. Your order is confirmed at the price shown at checkout.</p>
