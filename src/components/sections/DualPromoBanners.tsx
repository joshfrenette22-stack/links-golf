...
const banners = [
  { src: IMG_BANNER_CALLAWAY_IRONS, text: 'Up to 20% off Callaway irons this week', fallback: '#1c2e1a', label: 'banner-callaway-irons.jpg' },
  { src: IMG_BANNER_PUTTERS, text: '50+ putters in stock — find your perfect roll', fallback: '#3a2a18', label: 'banner-putters.jpg' },
]
